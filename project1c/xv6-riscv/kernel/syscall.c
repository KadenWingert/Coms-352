...
// Added these 3 system call declarations to be able to use and implement their functionalilty elsewhere
extern uint64 sys_getppid(void);
extern uint64 sys_ps(void);
extern uint64 sys_getschedhistory(void);

// Prototypes for the MLFQ scheduler system calls
int sys_startMLFQ(void);
int sys_stopMLFQ(void);
int sys_getMLFQInfo(void);
...
static uint64 (*syscalls[])(void) = {
    ...
    // Added these three function pointers to implement their functionality elsewhere
